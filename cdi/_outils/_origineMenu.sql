...
--
-- Hôte : localhost:8889
-- Généré le : sam. 08 mars 2025 à 17:41
...
--
ALTER TABLE `nav`
  MODIFY `id_nav` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `sous_nav`
--
ALTER TABLE `sous_nav`
  MODIFY `id_sous_nav` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
COMMIT;
